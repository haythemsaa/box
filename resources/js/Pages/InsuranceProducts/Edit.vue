        ...
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <h2 class="text-2xl font-semibold text-gray-900 mt-2">Modifier le produit d'assurance</h2>
...
const form = useForm({
    tenant_id: props.insuranceProduct.tenant_id,
    name: props.insuranceProduct.name,
    description: props.insuranceProduct.description,
    max_coverage_amount: props.insuranceProduct.max_coverage_amount,
    coverage_details: props.insuranceProduct.coverage_details,
    exclusions: props.insuranceProduct.exclusions,
    monthly_price: props.insuranceProduct.monthly_price,
    yearly_price: props.insuranceProduct.yearly_price,
    commission_rate: props.insuranceProduct.commission_rate,
    is_active: props.insuranceProduct.is_active,
    is_mandatory: props.insuranceProduct.is_mandatory,
});

const submit = () => {
    form.put(route('insurance-products.update', props.insuranceProduct.id), {
        preserveScroll: true,
    });
};
</script>
