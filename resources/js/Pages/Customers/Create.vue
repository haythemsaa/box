                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition" :class="form.type === 'individual' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200 hover:border-gray-300'">
                                <input
                                    v-model="form.type"
                                    type="radio"
                                    value="individual"
                            ...
                            <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition" :class="form.type === 'company' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200 hover:border-gray-300'">
                                <input
                                    v-model="form.type"
                                    type="radio"
                                    value="company"
